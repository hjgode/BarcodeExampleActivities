...
public class ClientBarcodeActivity21 extends Activity implements BarcodeReader.BarcodeListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView)findViewById(R.id.txtActivityTitle)).setText("ClientBarcodeActivity21");
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                final ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(
                        ClientBarcodeActivity21.this, android.R.layout.simple_list_item_1, list);
    ...
    public void onFailureEvent(BarcodeFailureEvent arg0) {
        runOnUiThread(new Runnable() {
            ...
            @Override
            public void run() {
                Toast.makeText(ClientBarcodeActivity21.this, "No data", Toast.LENGTH_SHORT).show();
            }
        });
    }
