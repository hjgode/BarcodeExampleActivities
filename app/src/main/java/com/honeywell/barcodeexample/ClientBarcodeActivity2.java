...
public class ClientBarcodeActivity2 extends Activity implements BarcodeReader.BarcodeListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnClient21.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent barcodeIntent = new Intent("android.intent.action.CLIENTBARCODEACTIVITY21");
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                final ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(
                        ClientBarcodeActivity2.this, android.R.layout.simple_list_item_1, list);
    ...
    public void onFailureEvent(BarcodeFailureEvent arg0) {
        runOnUiThread(new Runnable() {
            ...
            @Override
            public void run() {
                Toast.makeText(ClientBarcodeActivity2.this, "No data", Toast.LENGTH_SHORT).show();
            }
        });
    }
